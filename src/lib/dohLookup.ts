import type { WASMProofBuilder } from "./dnssec/dnssec_prover_wasm.js";
import init from "./dnssec/dnssec_prover_wasm.js";
import * as wasm from "./dnssec/dnssec_prover_wasm.js";
...
const sendQuery = async (
  ...
  if (query === null || query === undefined) {
    ...
    return JSON.parse(wasm.verify_byte_stream(proof, domain)) as LookupResult;
  }
